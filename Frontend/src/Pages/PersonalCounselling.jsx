    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://media.istockphoto.com/id/1435001168/photo/a-teen-girl-in-psychotherapy.jpg?s=612x612&w=0&k=20&c=A34KpyRI_m8CQxjfJHW9z-f3aMOY53EljP2zyXqMveM="
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <p
            className="text-lg sm:text-xl md:text-2xl text-white/95 font-light drop-shadow-lg animate-fade-up"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="animate-slide-in-right order-2 lg:order-1">
              <img
                src="https://media.istockphoto.com/id/1752862277/photo/close-up-of-an-unrecognisable-sad-patient-talking-about-her-problems-with-her-therapist-in-a.jpg?s=612x612&w=0&k=20&c=vCOBOyQZ7PnFmHxtp7Kv0R0TQHd1dOaqWcw0GiqGvAU="
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-gray-600">
                <p
                  ...
                  style={{ animationDelay: "0.3s" }}
                >
                  Personal counselling is a safe, confidential space where you
                  can explore your thoughts, feelings, and experiences with a
                  trained professional who provides support and guidance.
                </p>
                ...
                >
                  <strong>Who should consider it?</strong> Anyone dealing with
                  stress, anxiety, relationship issues, life transitions, or
                ...
                >
                  <strong>How it helps:</strong> Build confidence, develop
                  coping strategies, improve relationships, and gain clarity on
                  your life's direction in a supportive environment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className={`${benefit.color} hover:${benefit.hovercolor} transition-all duration-300 hover:scale-105 animate-bounce-in border-none shadow-lg`}
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardContent className="p-4 sm:p-6 text-center">
                  <div
                    className={`w-12 h-12 sm:w-16 sm:h-16 ${benefit.iconcolor} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white`}
                  >
                    {benefit.icon}
                  </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[rgba(204,171,219,0.3)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p
            className="text-gray-600 mt-3 sm:mt-4 animate-fade-in text-sm sm:text-base"
            style={{ animationDelay: "0.3s" }}
          >
            — Words of Wisdom
          </p>
