  ...
  const assessments = [
    {
      ...
      websiteLink:
        "https://careertest.edumilestones.com/student-dashboard/suitability-registration/login/MjYx/as124",
    },
    {
      ...
      websiteLink:
        "https://careertest.edumilestones.com/student-dashboard/suitability-registration/login/MjYx/hba2",
    },
    {
      name: "Personality + Interest + EQ Assessment",
      duration: "15-25 minutes",
      description:
        "A compact test combining personality, career interests, and emotional intelligence for better self and career understanding.",
      features: [
      ...
      websiteLink:
        "https://careertest.edumilestones.com/student-dashboard/suitability-registration/login/MjYx/my341",
    },
    {
      ...
      websiteLink:
        "https://careertest.edumilestones.com/student-dashboard/suitability-registration/login/MjYx/as204",
    },
  ];
    ...
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="relative py-40 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cGVyc29uYWxpdHklMjB0ZXN0fGVufDB8fDB8fHww"
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p
              className="text-xl text-white/90 mb-8 max-w-3xl mx-auto animate-fade-up"
              style={{ animationDelay: "0.2s" }}
            >
              Unlock your potential with comprehensive personality assessments
              and expert guidance for personal and professional growth.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div className="animate-fade-up order-2 lg:order-1">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6">
                  Our personality assessment services use scientifically
                  validated tools to provide deep insights into your character,
                  preferences, and behavioral patterns. These assessments help
                  you understand yourself better and make informed decisions
                  about your career and relationships.
                </p>
                <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6">
                  Combined with expert interpretation and personalized guidance,
                  our assessments provide actionable insights for personal and
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
                Discover the transformative power of understanding your
                personality
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              {assessments.map((assessment, index) => (
                <Card
                  key={index}
                  className="hover:shadow-xl transition-all duration-300 animate-fade-up border-none"
                >
                  <CardContent className="p-6 sm:p-8">
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">
                      {assessment.name}
                    </h3>
                    <p className="text-[#CCABDB] font-semibold mb-3 sm:mb-4 text-sm sm:text-base">
                      {assessment.duration}
                    </p>
                    ...
                    <Button
                      onClick={() =>
                        window.open(assessment.websiteLink, "_blank")
                      }
              ...
              {[
                {
                  ...
                  description:
                    "Select the personality assessment that suits your needs",
                },
                {
                  step: "2",
                  title: "Complete Test",
                  description:
                    "Answer questions honestly in a comfortable environment",
                },
                {
                  step: "3",
                  title: "Get Results",
                  description:
                    "Receive detailed report with insights and recommendations",
                },
                {
                  step: "4",
                  title: "Expert Consultation",
                  description: "Discuss results with our psychology experts",
                },
              ].map((item, index) => (
                <div
                  key={index}
